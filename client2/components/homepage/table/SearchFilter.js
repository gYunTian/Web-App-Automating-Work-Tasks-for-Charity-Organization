            ...
            focus:bg-white focus:border-gray-500'
				...
				<div className='block relative'>
					...
					<input
						...
						className='hover:border-gray-500 appearance-none rounded-r rounded-l sm:rounded-l-none border border-gray-400 border-b block pl-8 pr-6 py-2 px-4 w-full bg-white text-sm placeholder-gray-400 text-gray-700 focus:bg-white focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none'
					/>
				</div>
